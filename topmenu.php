<nav class="navbar navbar-expand-lg navbar-light bg-dark">
  <a class="navbar-brand text-light" href="#">نظام العلاوات والترفيعات -المبرمج محمد عزيز</a>
  ...
  <div class="collapse navbar-collapse" id="navbarNav">
    <ul class="navbar-nav ml-auto">
      <li class="nav-item active">
        <a class="nav-link btn btn-primary bg-primary" href="home.php" ><i class="fas fa-home"></i>الرئيسية </a>
      </li>
      <li class="nav-item">
