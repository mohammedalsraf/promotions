...
$resultTakadDate="";$notes="";
 ...
 if($_SERVER['REQUEST_METHOD']==='GET'){
  if(isset($_GET["id"])) {
    ...
    $jdchos =$row['jd'];
    $ctchos =$row['ct'];
    $empJopPos = $row['empJopPos'];
    $degree =$row['degree'];
    $stage =$row['stage'];
    $currentSalary = $row['currentSalary'];
    $lastAlawaDate = $row['lastAlawaDate'];
    $thanksDetails = $row['thanksDetails'];
    $oqobatDetails = $row['oqobatDetails'];
    $thanks = $row['thanks'];
    $oqobat = $row['oqobat'];
    $newAlawa = $row['newAlawa'];
    $lastTarfee = $row['lastTarfee'];
    $asgria = $row['asgria'];
    $thanksT = $row['thanksT'];
    $oqobatT = $row['oqobatT'];
    $newTarfee = $row['newTarfee'];
    $newSalary = $row['newSalary'];
    $towld = $row['towld'];
    $startDate = $row['startDate'];
    $taqadDate = $row['taqadDate'];
    $notes = $row['notes'];
 ...
 <div class="container mt-4 ">
                <div class="border p-3 bg-success text-light">
                    <h2 class="text-center">
                      حدث معلومات الموظف ثم قم بحساب العلاوات والترفيعات ثم اضغط تحديث
                    </h2>
  ...
  <div class="container mt-5">
    <form method="post" >
      <div class="row">
        <div class="col-md-2">
          <div class="mb-3">
            ...
            <input type="number" class="form-control " id="input1" name="archNumber" value="<?php  echo $archNumber?>" required readonly>
          </div>
          <div class="mb-3">
            <label for="input2" class="form-label"> الرقم الوظيفي</label>
            <input type="number" class="form-control" id="input2" name="recordNumber" value="<?php  echo $recordNumber?>" required readonly>
          </div>
          <div class="mb-3">
        ...
        <div class="col-md-2">
          ...
          <div class="mb-3">
            ...
            <input  type="text" class="form-control  bg-danger text-light" id="input2" name="currentSalary" value="<?php if(!empty($thesalary)){echo  $thesalary;}else{ echo "قم بتحديد الدرجة والمرحلة اولا";}?>">
          </div>
          <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control bg-danger text-light" id="input2" name="newSalary" value="<?php if(!empty($thesalary)){echo  $thesalary+$sDegree;}else{}?>">
          </div>
          <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control bg-success text-light" id="input2" name="taqadDate" value="<?php echo $resultTakadDate ?> ">
          </div>
          <div class="mb-3">
      ...
      <button type="submit" class="btn btn-primary" name="update">تحديث</button>
